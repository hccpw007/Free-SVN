...
export const useSvnStore = defineStore('svn', () => {
  ...
  async function mergeBranch(params: { srcUrl: string; revStart?: number; revEnd?: number; targetPath?: string }) { return call<OperationResult>('merge_branch', { ...params, src_url: params.srcUrl, rev_start: params.revStart, rev_end: params.revEnd, target_path: params.targetPath }) }
