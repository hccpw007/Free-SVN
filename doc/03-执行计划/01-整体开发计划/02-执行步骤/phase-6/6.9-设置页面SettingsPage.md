...
// 响应式同步：settingsStore 外部变更时同步到 form（问题21修复）
watch(() => settingsStore.defaultCheckoutDir, (v) => { form.defaultCheckoutDir = v })
watch(() => settingsStore.globalIgnorePattern, (v) => { form.globalIgnorePattern = v })
watch(() => settingsStore.darkMode, (v) => { form.darkMode = v })
    ...
    <div class="flex-1 overflow-auto p-6 max-w-2xl mx-auto w-full space-y-4">
        ...
        <div class="space-y-3">
          <div>
            ...
            <div class="flex gap-2 mt-1">
              ...
              <el-button size="default" @click="browseDir">{{ t('dialog.browse') }}</el-button>
            </div>
          </div>
          <div>
            <label class="text-xs text-slate-500 dark:text-slate-400">
      ...
      <el-card>
        ...
        <div class="space-y-2 text-xs text-slate-400 dark:text-slate-500">
          <p>Free-SVN 版本 0.0.1 · 基于 Tauri 2 · MIT 许可证</p>
