...
// 搜索框 300ms 防抖：watch searchQuery 变化后延迟触发 applyFilter
...
<template>
  ...
  <div v-else class="h-full flex flex-col">
    ...
    <div class="px-4 py-2 flex items-center gap-3 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700">
      <el-input v-model="fileListStore.searchQuery" :placeholder="t('workspace.searchPlaceholder')" size="default" clearable class="max-w-xs" />
...
- [ ] 搜索框 300ms 防抖（通过 watch searchQuery + setTimeout 300ms 在 <script> 中实现）
